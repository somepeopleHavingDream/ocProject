...
public class WxMemoryCacheClient {
	...
	/**
	 * accessToken的获取，绝对不要从缓存中直接存取，请从WxApiClient中获取：
	 * @param account
	 * @return
	 */
	...
	/**
	 * 获取唯一的公众号的accessToken，如果需要多账号，请自行处理accessToken的获取，
	 * 绝对不要从缓存中直接获取，请从WxApiClient中获取：
	 * @return 
	 */
	 ...
	 * @return
	 */
	public static OAuthAccessToken getAuthAccessToken(String account) {
